  ...
  <div class="row gy-4">
    <div class="col-lg-12 col-md-12 footer-about">
      <a href="<?php echo esc_url(home_url('/')); ?>" rel="home" class="logo">
        <span class="sitename">あめちゃんグルメ</span>
      </a>
      <div class="footer-contact pt-3">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/amechan-logo.png" alt="">
      </div>
      <div class="social-links d-flex mt-4">
        <a href="https://www.instagram.com/amechan_gourmet?igsh=MW43ZmdrcnE0czBhdQ=="><i class="bi bi-instagram"></i></a>
      </div>
      <span>Instagram</span>
    </div>
...
<div class="container copyright text-center mt-4">
  <p>© <span>2024</span> <strong class="px-1 sitename">あめちゃんグルメ</strong></p>
  <div class="credits">
